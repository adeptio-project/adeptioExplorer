...
/usr/bin/adeptio-cli masternode list > /home/explorer/explorer/public/jsondata/masternode_full_list.json
/usr/bin/adeptio-cli masternode list > | awk '{print $7}' > /home/explorer/explorer/public/jsondata/masternode_full_node_list.json
...
/usr/bin/adeptio-cli masternode list | tail -n 10 | awk '{print $7}' > /home/explorer/explorer/public/jsondata/last_10_activated_masternodes.json
